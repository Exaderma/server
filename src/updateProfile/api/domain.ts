export interface RepositoryUpdateProfile {
    ...
    // Professional
    updateProfessionalFirstName : (email : string, firstName : string) => Promise<string>,
    updateProfessionalLastName : (email : string, lastName : string) => Promise<string>,
    updateProfessionalEmail : (email : string, newEmail : string) => Promise<string>,
    updateProfessionalPassword : (email : string, password : string) => Promise<string>,
    updateProfessionalPhone : (email : string, phone : string) => Promise<string>,
    updateProfessionalDepartment : (email : string, department : string) => Promise<string>,
    updateProfessionalAddress : (email : string, address : string) => Promise<string>,
}