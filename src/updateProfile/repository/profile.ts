...
export class UpdateProfile implements RepositoryUpdateProfile {
    ...
    // Patient
    public async updatePatientFirstName(email: string, firstName: string): Promise<string> {
    ...
    public async updatePatientLastName(email: string, lastName: string): Promise<string> {
        const patient = await this.dbClient.manager.findOne(PatientEntity, {
            where: {
                email: email,
            },
    ...
    public async updatePatientEmail(email: string, newEmail: string): Promise<string> {
        const patient = await this.dbClient.manager.findOne(PatientEntity, {
            where: {
                email: email,
            },
    ...
    public async updatePatientPhone(email: string, phone: string): Promise<string> {
        const patient = await this.dbClient.manager.findOne(PatientEntity, {
            where: {
                email: email,
            },
    ...
    public async updatePatientPassword(email: string, password: string): Promise<string> {
        const patient = await this.dbClient.manager.findOne(PatientEntity, {
            where: {
                email: email,
            },
    ...
    // Professional
    public async updateProfessionalFirstName(email: string, firstName: string): Promise<string> {
    ...
    public async updateProfessionalLastName(email: string, lastName: string): Promise<string> {
        const professional = await this.dbClient.manager.findOne(ProfessionalEntity, {
            where: {
                email: email,
            },
    ...
    public async updateProfessionalEmail(email: string, newEmail: string): Promise<string> {
        const professional = await this.dbClient.manager.findOne(ProfessionalEntity, {
            where: {
                email: email,
            },
    ...
    public async updateProfessionalPassword(email: string, password: string): Promise<string> {
        const professional = await this.dbClient.manager.findOne(ProfessionalEntity, {
            where: {
                email: email,
            },
    ...
    public async updateProfessionalPhone(email: string, phone: string): Promise<string> {
        const professional = await this.dbClient.manager.findOne(ProfessionalEntity, {
            where: {
                email: email,
            },
    ...
    public async updateProfessionalDepartment(email: string, department: string): Promise<string> {
        const professional = await this.dbClient.manager.findOne(ProfessionalEntity, {
            where: {
                email: email,
            },
    ...
    public async updateProfessionalAddress(email: string, address: string): Promise<string> {
        const professional = await this.dbClient.manager.findOne(ProfessionalEntity, {
            where: {
                email: email,
            },
