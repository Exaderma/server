export interface RepositoryImage {
    ...
    GetPatientImageProfile(patientEmail: string, id_patient?: number): Promise<string>;
    GetProfessionalImageProfile(professionalEmail: string, id_professional?: number): Promise<string>;
