...
import { OrganisationEntity, OrganisationMember } from "../../entity/organisation";
...
export class OrganisationRepository {
  ...
  public async createOrganisation(organisation: OrganisationEntity, user: {id: number, type: string}): Promise<void> {
  ...
  public async addMember(organisationId: number, member: {id: number, type: string}): Promise<void> {
    const repo = this.client.getRepository(OrganisationMember);
